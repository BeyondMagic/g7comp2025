...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "IDENT", "PLUS",
...
{
      -7,     0,    -7,    -7,    -6,    27,    -7,    -7,    13,    27,
      -7,    32,    -2,    27,    27,    27,    27,    -7,    21,    -7,
      -7,    15,    15,    -7,    -7,    -7
};
...
{
       2,     0,     1,    12,    13,     0,     2,     3,     0,     0,
      13,     0,     0,     0,     0,     0,     0,     5,     0,    11,
       6,     7,     8,     9,    10,     4
};
...
{
       2,     3,     4,     3,     4,     9,    11,     5,    12,     5,
      18,     6,    20,     6,    21,    22,    23,    24,    13,    14,
      15,    16,    15,    16,     0,    17,    13,    14,    15,    16,
       3,    10,     0,    25,     0,     0,     5,    13,    14,    15,
      16,     0,    19
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     3,     4,    11,     5,     9,     6,     9,
       9,    13,    14,    13,    13,    14,    15,    16,     5,     6,
       7,     8,     7,     8,    -1,    12,     5,     6,     7,     8,
       3,     4,    -1,    12,    -1,    -1,     9,     5,     6,     7,
       8,    -1,    10
};
...
{
       0,    16,     0,     3,     4,     9,    13,    17,    18,    11,
       4,    18,    16,     5,     6,     7,     8,    12,    18,    10,
      14,    18,    18,    18,    18,    12
};
...
#line 47 "src/parser.y"
                         { printf("Uso de variável: %s\n", (yyvsp[0].id)); (yyval.intValue) = 0; }
